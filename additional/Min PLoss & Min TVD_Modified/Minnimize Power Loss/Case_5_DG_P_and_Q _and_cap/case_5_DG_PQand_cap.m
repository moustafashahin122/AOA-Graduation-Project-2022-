...
Pdg_Size=pp5;
Qdg_Size=Pdg_Size*tan(acos(0.9));
%==========================================================================
fprintf('=================================================================')
DG_Locations_Size_Kw_KVAR=[Locations_DG' Pdg_Size' Qdg_Size']
Pdg_Total_Kw=[sum(DG_Locations_Size_Kw_KVAR(:,2)) sum(DG_Locations_Size_Kw_KVAR(:,3))]
%==========================================================================
fprintf('=================================================================')
...
% [minimum_voltage,bus_nummin] = min(V_bus)
% [maximum_voltage,bus_nummax] =max(V_bus)
% fprintf('case 1 voltages')
% V_bus
