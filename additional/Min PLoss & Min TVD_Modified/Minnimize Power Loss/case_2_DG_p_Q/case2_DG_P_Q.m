...
Qc_max=3000;                                   % Maximum limit of capacitor
%==========================================================================
...
DG_Size_kVAR=Qcc_Size*tan(acos(0.9));
%==========================================================================
Qcc_Locations_Size_Kvar=[Qcc_Locations Qcc_Size DG_Size_kVAR]
...
% [minimum_voltage,busmin] = min(V_bus)
% [maximum_voltage, busmax] =max(V_bus)
% fprintf('case 3 voltages')
% V_bus
