...
function [Total_PLoss,minimum_voltage] =case_3_DG_p_Q_param(trial,iter,n_materials,n_capacitors,Q_max,Q_min)
...
Nb=34;                                                       % No. of buses
%==========================================================================
Materials_no=n_materials;                                      % Number of Particles                               
dim=n_capacitors;                                        % Number of control varaibles
Max_iter=iter;                                % Maximum number of iterations
%==========================================================================
% C3=2;C4=.5;                                 %cec and engineering problems
C3=1;C4=2;                                 %standard Optimization functions
%==========================================================================
Qc_min=Q_min;                                    % Minimum limit of capacitor
Qc_max=Q_max;                                   % Maximum limit of capacitor
%==========================================================================
...
bvar1(ss1,1)=ss2;
PP_Size_KW=bvar1;
QQ_Size_kVAR=bvar1*tan(acos(0.9));
...
ww= [' trial n ' , num2str(trial),' max iter ', num2str(iter),' particales n. ', num2str(n_materials),' N device ',num2str(n_capacitors) ];


xx=[' n.devices ', num2str(n_capacitors) ,' trial n ' , num2str(trial),' case 3 '];
temp = [xx ,'.png'];
title(xx);
yy= num2str(Qcc_Locations_Size_Kvar);
zz= [' Total PLoss ', num2str(Total_PLoss),' Total QLoss ',num2str(Total_QLoss) ];
text(15,.97,yy)
text(15,.99,zz)
text(15,.995,ww)
saveas(gca,temp);
