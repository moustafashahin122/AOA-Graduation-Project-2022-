...
function [Total_PLoss,minimum_voltage] =case_1_DG_p_param(trial,iter,n_materials,n_capacitors,Q_max,Q_min)
...
xx=[' n.devices ', num2str(n_capacitors) ,' trial n ' , num2str(trial),' case 1 '];
temp = [xx ,'.png'];
title(xx);
