...
function AOA_param(iter,number_of_capacitors,Q_max,Q_min)
...
Nb=34;                                                       % No. of buses
%==========================================================================
Materials_no=34;                                      % Number of Particles                               
dim=number_of_capacitors;                                        % Number of control varaibles
...
mm= [' number of iter ', num2str(iter),' NC ',num2str(number_of_capacitors) ]


xx=[' total power loss ' , num2str(Total_PLoss),' total Qloss ', num2str(Total_QLoss)]
temp = [xx,mm ,'.png'];
title(mm);
